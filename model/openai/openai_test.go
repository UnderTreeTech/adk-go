...
func TestSanitizeOpenAIMessages(t *testing.T) {
	tc := func(id, name, args string) toolCall {
	...
	tests := []struct {
		...
		{
			name: "orphaned_tool_call_removed_preserving_subsequent_turns",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
				{Role: "assistant", ToolCalls: []toolCall{tc("tc_1", "func1", `{}`)}},
		...
		{
			name: "orphaned_tool_call_in_middle_preserves_valid_turns",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Do X"},
				{Role: "assistant", ToolCalls: []toolCall{tc("tc_1", "func1", `{}`)}},
				{Role: "tool", ToolCallID: "tc_1", Content: `{"result": "ok"}`},
				{Role: "assistant", Content: "X done"},
				{Role: "user", Content: "Do Y"},
				{Role: "assistant", ToolCalls: []toolCall{tc("tc_2", "func2", `{}`)}},
				{Role: "user", Content: "Continue"},
				{Role: "assistant", Content: "Y done"},
			},
			want: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Do X"},
		...
		{
			name: "multiple_orphaned_tool_calls_all_removed",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
				{Role: "assistant", ToolCalls: []toolCall{tc("tc_1", "func1", `{}`)}},
		...
		{
			name: "partial_tool_call_match_keeps_matched_calls",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
		...
		{
			name: "all_tool_calls_orphaned_no_content_returns_empty",
			messages: []message{
				{Role: "assistant", ToolCalls: []toolCall{tc("tc_1", "func1", `{}`)}},
			},
			want: []message{},
		...
		{
			name: "all_tool_calls_orphaned_with_text_preserves_text",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
		...
		{
			name: "empty_tool_call_id_is_not_tracked",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
		...
		{
			name: "orphaned_tool_response_removed",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
				{Role: "assistant", ToolCalls: []toolCall{tc("tc_1", "func1", `{}`)}},
		...
		{
			name: "multiple_orphaned_tool_responses_all_removed",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
		...
		{
			name: "tool_response_with_empty_tool_call_id_kept",
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
		...
		{
			name: "orphaned_response_removal_exposes_orphaned_call_no_content",
			messages: []message{
				{Role: "assistant", ToolCalls: []toolCall{tc("tc_1", "func1", `{}`)}},
				{Role: "tool", ToolCallID: "tc_orphan", Content: `{"result": "orphan"}`},
			},
		...
		},
		{
			...
			messages: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
				{Role: "assistant", ReasoningContent: "Let me think about this", ToolCalls: []toolCall{tc("tc_1", "func1", `{}`)}},
				{Role: "user", Content: "Continue"},
			},
			want: []message{
				{Role: "system", Content: "You are helpful"},
				{Role: "user", Content: "Hello"},
				{Role: "assistant", ReasoningContent: "Let me think about this"},
				{Role: "user", Content: "Continue"},
			},
		},
	}
